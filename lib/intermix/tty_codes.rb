...
module Intermix
  module TtyCodes
    ...
    csi %w(@),    nil,        'ich',    'parm_ich'
    csi %w(A),    %w(1 2),    'kri',    'key_sr'
    csi %w(A),    nil,        'cuu1',   'cursor_up'
    csi %w(B),    %w(1 2),    'kind',   'key_sf'
    csi %w(B),    nil,        'cud',    'parm_down_cursor'
    csi %w(C),    %w(1 2),    'kRIT',   'key_sright'
    csi %w(C),    nil,        'cuf',    'parm_right_cursor'
    csi %w(D),    %w(1 2),    'kLFT',   'key_sleft'
    csi %w(D),    nil,        'cub',    'parm_left_cursor'
    csi %w(F),    %w(1 2),    'kEND',   'key_send'
    csi %w(G),    nil,        'hpa',    'column_address'
    csi %w(H),    %w(1 2),    'kHOM',   'key_shome'
    csi %w(H),    nil,        'cup',    'cursor_address'
    csi %w(H),    nil,        'home',   'cursor_home'
    csi %w(J),    nil,        'ed',     'clr_eos'
    csi %w(K),    nil,        'el',     'clr_eol'
    csi %w(K),    nil,        'el1',    'clr_bol'
    csi %w(L),    nil,        'il',     'parm_insert_line'
    csi %w(L),    nil,        'il1',    'insert_line'
    csi %w(M),    nil,        'dl',     'parm_delete_line'
    csi %w(M),    nil,        'dl1',    'key_mouse'
    csi %w(M),    nil,        'kmous',  nil
    ...
    csi %w(P),    nil,        'dch',    'parm_dch'
    csi %w(P),    nil,        'dch1',   'delete_character'
    ...
    csi %w(R),    nil,        'u6',     'user6'
    csi %w(S),    %w(1 2),    'kf16',   'key_f16'
    csi %w(S),    %w(1 3),    'kf52',   'key_f52'
    csi %w(S),    %w(1 5),    'kf28',   'key_f28'
    csi %w(S),    %w(1 6),    'kf40',   'key_f40'
    csi %w(S),    nil,        'indn',   'parm_index'
    csi %w(T),    nil,        'rin',    'parm_rindex'
    csi %w(X),    nil,        'ech',    'erase_chars'
    csi %w(Z),    nil,        'cbt',    'key_btab'
    csi %w(Z),    nil,        'kcbt',   nil
    csi %w(c),    nil,        'u9',     'user9'
    csi %w(d),    nil,        'vpa',    'row_address'
    ...
    csi %w(r),    nil,        'csr',    'change_scroll_region'
